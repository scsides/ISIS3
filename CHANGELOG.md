...
### Fixed
 ...
 - Removed the library file name from the library path before it was added to ALLLIBDIRS for the loader -L flag. [#3886](https://github.com/USGS-Astrogeology/ISIS3/issues/3986)
